                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        decoration:
                            const InputDecoration(labelText: 'Jumlah Bantuan'),
                        keyboardType: TextInputType.number,
                      ),
                      TextFormField(
                        controller: jmlhKKController,
                        decoration:
                            const InputDecoration(labelText: 'Jumlah KK'),
                        keyboardType: TextInputType.number,
                      ),
                      TextFormField(
                      ...
                      TextFormField(
                        ...
                        decoration:
                            const InputDecoration(labelText: 'Jumlah Laki'),
                        keyboardType: TextInputType.number,
                      ),
                      TextFormField(
                        controller: debitAirController,
                        decoration:
                            const InputDecoration(labelText: 'Debit Air'),
                      ),
                      TextFormField(
                        controller: pemakaianAirController,
                        decoration:
                            const InputDecoration(labelText: 'Pemakaian Air'),
                      ),
                      TextFormField(
                        controller: sistemPengelolaanController,
                        decoration: const InputDecoration(
                            labelText: 'Sistem Pengelolaan'),
                      ),
                      TextFormField(
                        controller: sumberAirController,
                        decoration:
                            const InputDecoration(labelText: 'Sumber Air'),
                      ),
                      TextFormField(
                        controller: hargaAirController,
                        decoration:
                            const InputDecoration(labelText: 'Harga Air'),
                        keyboardType: TextInputType.number,
                      ),
                      ...
                      TextFormField(
                        ...
                        decoration:
                            const InputDecoration(labelText: 'TDS (ppm)'),
                        keyboardType: TextInputType.number,
                      ),
                      TextFormField(
                        controller: ECController,
                        decoration:
                            const InputDecoration(labelText: 'EC (µS/cm)'),
                        keyboardType: TextInputType.number,
                      ),
                      TextFormField(
                        controller: ORPController,
                        decoration:
                            const InputDecoration(labelText: 'ORP (mV)'),
                        keyboardType: TextInputType.number,
                      ),
